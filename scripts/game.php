  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <div class="card p-5">
        ...
        <div class="row">
          <div class="col">
            <h5 class="text-success">Questão n.º
              <strong><?= $current_question + 1 . ' / ' . $total_questions ?></strong></h5>
          </div>
        ...
        <div class="px-5 mt-5">
          <h3 class="mb-5 border border-3 p-3" style="cursor: pointer" id="answer_0"><?= $capitals[$answers[0]][1] ?>
          </h3>
          <h3 class="mb-5 border border-3 p-3" style="cursor: pointer" id="answer_1"><?= $capitals[$answers[1]][1] ?>
          </h3>
          <h3 class="mb-5 border border-3 p-3" style="cursor: pointer" id="answer_2"><?= $capitals[$answers[2]][1] ?>
          </h3>
        </div>
